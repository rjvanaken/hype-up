  ...
  return (
    <button 
      className={cn(
        ...
        variant === 'follow-alt' && 'bg-card border-0 text-primary hover:bg-cool-brand-50 hover:text-cool-brand-800 active:bg-cool-brand-100',
        variant === 'unfollow-alt' && 'bg-transparent inset-ring-2 inset-ring-white text-primary-foreground hover:bg-card/20 active:bg-card/30 active:text-cool-brand-800',
        className
      )}
      {...props}
    >
