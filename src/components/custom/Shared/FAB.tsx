    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      {expanded && (
        <div className="flex flex-col items-end gap-3">
          <button
            className="flex items-center gap-3 rounded-full bg-popover pl-2 pr-5 py-2 shadow-md"
      ...
      <button
        className={cn(
          "flex items-center justify-center size-14 rounded-full bg-primary text-primary-foreground shadow-lg transition-transform",
          expanded && "rotate-90"
        )}
